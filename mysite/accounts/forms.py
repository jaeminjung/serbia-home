...
class UserRegisterForm(forms.ModelForm):
    ...
    class Meta:
        model = User
        fields = ['username', 'password', 'password2', 'email', 'email2', 'name',
                  'pythonClass', 'WebDevelop', 'Korea_culture']
    ...
    def clean_password2(self):
        ...
        if password_qs.exists():
            raise forms.ValidationError("This password has already been registered")
        return password
